...
def read_target_data():
    ...
    for filename in target_file_list:
        ...
        # file_df = rename_col(file_df, target_col)

        # split_results = file_df['도로명주소'].apply(split_address, result_type='expand')
        # file_df[['도로명주소', '상세주소']] = split_results
